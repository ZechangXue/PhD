...
def evaluate_model(trainX, trainy, testX, testy, kernel_size, filters, Batch_size, learn):
	...
	# 保存到Excel
	df.to_excel("CNN_model_performance.xlsx", index=False)
	# 绘制混淆矩阵
...
#             _, history = evaluate_model(trainX, trainy, testX, testy, 11, filters)  # kernel_size fixed at 11
#             histories.append(history.history)
#         all_histories.append(histories)
#
#     # Plot all averaged curves
#     plot_all_curves(all_histories, filters_list)

# def run_experiment(repeats=5):
#     # Define different filters
#     learn_list = [0.00035, 0.0005, 0.00065]
#     all_histories = []
#
...
#         histories = []
#         for r in range(repeats):
#             _, history = evaluate_model(trainX, trainy, testX, testy, 11, 7, 128, learn)  # kernel_size fixed at 11
#             histories.append(history.history)
#         all_histories.append(histories)
#
#     # Plot all averaged curves
